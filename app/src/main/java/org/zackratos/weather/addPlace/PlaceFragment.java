...
public abstract class PlaceFragment extends BaseFragment {
    ...
    @BindView(org.zackratos.weather.R.id.place_list)
    ...
    protected class PlaceAdapter<T extends Place> extends BaseQuickAdapter<T, BaseViewHolder> {
        public PlaceAdapter(@Nullable List<T> data) {
            super(org.zackratos.weather.R.layout.item_add_place, data);
        }

        @Override
        protected void convert(BaseViewHolder helper, T item) {
            helper.setText(org.zackratos.weather.R.id.add_place_item_text, item.getName());
        }
    }
